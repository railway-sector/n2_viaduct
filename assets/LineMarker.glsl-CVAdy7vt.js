import{wg as Q,GV as X,GW as ee,Fw as te,Fu as ie,GX as re,GY as ae,FB as o,GO as se,G8 as oe,GN as ne,FA as w,GZ as ce,G_ as le,Fx as pe,Fz as de,FC as he,Gx as ve,FE as ue,G$ as N,H0 as G,H1 as me,H2 as fe,Gc as ge,fK as Se,FF as Pe,FG as ye,_ as _e,FH as C,FI as H,FJ as we,FK as R,FL as L,Ge as ze,FN as xe,FO as $e,FP as Te,FR as V,FS as be,H3 as Ve,H4 as E,H5 as U,H6 as ke,H7 as Oe,H8 as Fe,FT as De,n as p,FU as d,fH as We,Gf as Ce,H9 as I,qH as Le,GF as Me,kT as je,FZ as Ae,c9 as B,y8 as Ne,gh as q,ck as Y,Ha as Ge}from"./index-C8_nYniG.js";function J(r){const e=new Q,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(X,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
}`),P&&(e.include(G),S.constants.add("relativeMarkerSize","float",me/N).constants.add("relativeTipLineWidth","float",fe).code.add(o`
